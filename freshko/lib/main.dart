...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Animation<Offset> getAnimation() {
      return Tween<Offset>(begin: Offset(0.5, 0.0), end: Offset.zero)
          .animate(_controller);
    }
    ...
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text(
          'Freshko',
          style: TextStyle(fontFamily: 'ArimaMadurai', fontSize: uniWidth / 12),
        ),
      ),
      drawer: new Drawer(
        child: new Container(
                        ...
                        child: SlideTransition(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ...
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Fruits and\n Vegetables')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Grocery and\n Stamples')),
                              FlatButton(
                                  onPressed: () {}, child: Text('Beverages')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Biscuits and\n Snacks')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Beauty Products')),
                              FlatButton(
                                  onPressed: () {}, child: Text('Household')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Breakfast and\n Dairy')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Baby and\n Kids')),
                              FlatButton(
                                  onPressed: () {},
                                  child: Text('Noodles/Instant Foods')),
                            ],
                          ),
                        ),
                      )
